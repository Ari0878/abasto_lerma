...
<head>
    ...
    <title>Registrar Ingreso - Finanzas</title>
        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="logo-container">
                ...
                <div class="header-titles d-none d-md-block">
                    <div class="header-title">Gobierno del Estado de México</div>
                    <div class="header-subtitle">Registro de Ingresos</div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="año" id="año" class="form-control" 
                                   value="{{ old('año', date('Y')) }}" required min="2000" max="2100">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="cantidad" id="cantidad" 
                                   class="form-control" value="{{ old('cantidad') }}" required>
                            <small class="text-muted">Ingrese la cantidad con dos decimales</small>
                        </div>
                    </div>
                    
                    <div class="col-12">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('ingresos.index') }}" class="btn btn-edomex-outline me-md-2">
