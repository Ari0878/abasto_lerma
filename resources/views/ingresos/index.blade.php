    ...
    <div class="card-header-modern">
      <div class="d-flex justify-content-between align-items-center">
        <h2 class="card-title-modern">
          ...
          Ingresos del año {{ $año }}
        </h2>
        <a href="{{ route('ingresos.create') }}" class="btn-edomex">
    ...
    <div class="card-body">
      <form method="GET" class="mb-4">
        ...
        <div class="d-flex gap-2">
          <input type="number" name="año" id="año" value="{{ $año }}" min="2000" max="2100" class="form-control-modern w-25">
          <button class="btn-edomex">
      ...
      @if($ingresos->isEmpty())
        <div class="alert alert-info">No hay ingresos registrados para este año.</div>
      @else
        @php
          $meses = [
        ...
        <div class="total-annual">
          ...
          Total del año {{ $año }}: <strong>${{ number_format($total, 2) }}</strong>
        </div>
      @endif

      <a href="{{ route('ingresos.comparar') }}" class="btn btn-outline-primary mt-4 d-inline-flex align-items-center">
        <i class="bi bi-graph-up-arrow me-2"></i> Comparar Años
      </a>
    </div>
  </div>
</div>
