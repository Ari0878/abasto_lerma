...
<head>
    ...
    <title>Editar Región - Gobierno del Estado de México</title>
...
<div class="container mb-5">
    <div class="card card-shadow">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <div>
                <h2 class="h5 text-primary mb-0">
                    <i class="bi bi-pencil-square me-2"></i>Editar Región
                </h2>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('region_salvar', ['id' => $region->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="floatingNumero" class="form-label">Número de Región</label>
                        <input type="text" class="form-control" name="numero_region" id="floatingNumero" placeholder="Ej. Región 1" value="{{ $region->numero_region }}">
                        @if($errors->first('numero_region'))
                            <div class="form-text text-danger">El campo no es correcto.</div>
                        @endif
                    </div>

                    <div class="col-md-6">
                        <label for="floatingNombre" class="form-label">Nombre de Región</label>
                        <input type="text" class="form-control" name="nombre" id="floatingNombre" placeholder="Ej. Valles Centrales" value="{{ $region->nombre }}">
